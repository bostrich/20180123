 ...
 *
 */
public class TimeRecyclerViewAdapter extends RecyclerView.Adapter<TimeRecyclerViewAdapter.MyViewHolder> implements View.OnClickListener, View.OnLongClickListener {
    ...
    public TimeRecyclerViewAdapter(Context context, List<DbModel> list) {
    ...
    public int getItemViewType(int position) {
        return mList.get(position).getBoolean("hasimage")?Type_HASIMA:Type_NOIMA;
    }
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        DbModel dbModel=mList.get(position);
